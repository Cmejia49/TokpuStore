...
import { fetchById } from "../service/productService";
const initialState = {
    item:[],
    status: 'idle',
    error: null,
...
export const retrieveDetail = createAsyncThunk('detail/retrieveDetail', async(id)=>{
    const data = await fetchById(id).then(res =>{
        return res;
    })
...
export const getPrice = (state) => state.detail.price;
